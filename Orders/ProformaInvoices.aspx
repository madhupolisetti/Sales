<%@ Page Language="C#" MasterPageFile="~/PostLogin.Master" AutoEventWireup="true" CodeBehind="ProformaInvoices.aspx.cs" Inherits="Orders.ProformaInvoices" %>
                ...
                <div class="portlet-body pad-top-0">
                    <div id="tbl">
                        ...
                        <div class="row margin-bottom-15" id="secondRow" style="display: none;">
                            ...
                            <div class="col-sm-3">
                                <label class="table-head">Proforma Invoice Status</label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#lable_href_name").html('Proforma Invoices');
            var accessRole,adminId;
            ...
            $("#btnCreate,#btnPayment").attr("class", "enable-icn");
            ...
            function getInvoices(isdownload) {
                ...
                invoiceSearchData.isProformaInvoice = true;
