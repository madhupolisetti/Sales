<%@ Page Title="" Language="C#" MasterPageFile="~/PostLogin.Master" AutoEventWireup="true" CodeBehind="AccountLookUp.aspx.cs" Inherits="Orders.AccountLookUp" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $("#lable_href_name").html('Account Lookup');
        });
    </script>
</asp:Content>
